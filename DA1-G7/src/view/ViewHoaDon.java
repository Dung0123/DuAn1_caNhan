...
//                    hd.getTrangthai()
    ...
    private void exportToExcel(JTable table, String filePath) {
        try (Workbook workbook = new XSSFWorkbook(); FileOutputStream fileOut = new FileOutputStream(filePath)) {
            ...
            System.err.println("Error while writing to Excel file: " + filePath);
            e.printStackTrace();
        }
    }
    ...
    private void xuatHoaDon() {
        ...
        String ma1 = (String) this.tableHoaDon.getValueAt(row, 1);
        int tt1;
        String tt = this.tableHoaDon.getValueAt(row, 9).toString();
        if (tt.equals("Chua thanh toán")) {
...
//        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        this.xuatHoaDon();        // TODO add your handling code here:
