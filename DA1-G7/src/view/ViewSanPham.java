...
//    private void onChangeSearchSanPhamChiTiet() {
...
//    }
    ...
    private SanPhamChiTiet updateSanPhamChiTiet() {
        ...
        sanPhamChiTiet = new SanPhamChiTiet(ma, chatLieuSelected.getId(),
                chieuDaiTaySelected.getId(), kichCoSelected.getId(),
                mauSacSelected.getId(), coAoSelected.getId(), Integer.parseInt(soLuong),
            ...
            .addGroup(jPanel16Layout.createSequentialGroup()
                ...
                .addGroup(jPanel16Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel16Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(textField24, javax.swing.GroupLayout.PREFERRED_SIZE, 239, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(textField25, javax.swing.GroupLayout.PREFERRED_SIZE, 206, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel12Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel9)
                    .addComponent(textField25, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnThemThuocTinhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemThuocTinhActionPerformed
        if (rdoThuongHieu.isSelected()) {
            ...
            if (confirm == 0) {
                JOptionPane.showMessageDialog(this, thuongHieuService.update(addThuongHieu()));
                showDataProperties();
            }
        } else if (rdoDanhMuc.isSelected()) {
